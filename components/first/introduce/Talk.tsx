...
const Talk = ({ contents, speaker, Icon, classNames }: TalkProps) => {
  return (
    <li className={clsx('flex flex-col whitespace-pre relative', classNames)}>
      <div className="flex flex-col relative space-y-5 items-start justify-start tablet:px-8 tablet:py-10 p-6 bg-background-secondary rounded-3xl">
        ...
        <div className="absolute bottom-[-1rem] left-[3rem] h-10 w-10 bg-background-secondary rounded-lg rotate-[45deg]" />
      </div>
      {Icon}
    </li>
  )
