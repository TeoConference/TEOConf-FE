...
const EliceLab = () => {
  return (
    <section className="relative w-full min-h-[500px] tablet:min-h-[600px] desktop:min-h-[700px] overflow-hidden">
      ...
      {/* 보라색 계열 오버레이 */}
      <div className="absolute inset-0 bg-gradient-to-b from-[#A855F7]/60 via-[#8814F4]/70 to-[#A855F7]/60" />
      ...
      <div className="relative z-10 w-full h-full min-h-[500px] tablet:min-h-[600px] desktop:min-h-[700px] flex items-center justify-center px-4 tablet:px-8">
        <div className="flex flex-col items-center justify-center gap-6 tablet:gap-8 text-center max-w-4xl mx-auto">
          {/* 슬로건 */}
          <div className="flex flex-col gap-2 tablet:gap-4">
            <h2 className="text-white text-[1.5rem] tablet:text-[2rem] desktop:text-[2.5rem] font-semibold leading-tight">
              TEOConf 2025는 K-하이테크 플랫폼
            </h2>
            <p className="text-white text-[1.25rem] tablet:text-[1.5rem] desktop:text-[2rem] font-medium leading-tight">
              엘리스Lab과 함께합니다.
            </p>
          </div>
