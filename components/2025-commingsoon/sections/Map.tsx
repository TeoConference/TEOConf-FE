...
const Map = () => {
  ...
  useEffect(() => {
    ...
    window.kakao.maps.load(() => {
      ...
      // 커스텀 오버레이 설정
      const content = `
        <div class="relative bottom-[115px] bg-white rounded-md shadow-lg px-4 py-2 border border-gray-300 text-xl">
          <a href="https://map.kakao.com/link/map/74968626" target="_blank" rel="noopener noreferrer" class="text-gray-800 no-underline hover:underline font-bold text-sm">
            엘리스랩 성수
          </a>
