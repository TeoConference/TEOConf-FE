  ...
  return (
    <ModalBackDrop onClick={powerModal}>
      <CreateModalContainer>
        <div className="text-[1.125rem] tablet:text-[1.625rem] font-semibold mb-7">
          개인정보 처리방침
        </div>
        <div className="text-[0.8rem] tablet:text-[1rem] h-[60vh] bg-[#F8F8F8] w-full overflow-y-scroll p-[15px] break-keep">
        ...
        <button
          ...
          onClick={powerModal}
        >
          <span className="text-white text-[1rem]">닫기</span>
        </button>
      </CreateModalContainer>
    </ModalBackDrop>
  )
